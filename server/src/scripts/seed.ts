	...
	try {
		...
		const products = await Product.insertMany([
			// Dairy Alternatives - Milk
			{
				...
				nutritionSummary:
					'120 cal, 5g fat, 16g carbs, 3g protein per serving',
				ingredientSummary:
					'Oat base (water, oats), rapeseed oil, sea salt',
			},
			{
				...
				nutritionSummary:
					'30 cal, 2.5g fat, 1g carbs, 1g protein per serving',
				ingredientSummary:
			...
			},
			{
				...
				brand: 'Silk',
				description:
					'Classic organic soy milk with complete plant protein.',
				...
				nutritionSummary:
					'110 cal, 4.5g fat, 9g carbs, 8g protein per serving',
				ingredientSummary:
			...
			// Dairy Alternatives - Cheese
			{
				...
				nutritionSummary:
					'70 cal, 6g fat, 2g carbs, 2g protein per serving',
				ingredientSummary:
			...
			},
			{
				...
				nutritionSummary:
					'70 cal, 5g fat, 4g carbs, 0g protein per slice',
				ingredientSummary:
			...
			// Protein
			{
				...
				nutritionSummary:
					'90 cal, 5g fat, 2g carbs, 10g protein per serving',
			...
			},
			{
				...
				imageUrl:
					'https://images.unsplash.com/photo-1623428187969-5da2dcea5ebf?w=400',
				nutritionSummary:
					'140 cal, 6g fat, 10g carbs, 16g protein per serving',
				ingredientSummary:
			...
			},
			{
				...
				nutritionSummary:
					'230 cal, 14g fat, 5g carbs, 20g protein per patty',
				ingredientSummary:
			...
			// Pantry
			{
				...
				nutritionSummary:
					'60 cal, 0.5g fat, 5g carbs, 8g protein per 2 tbsp',
				ingredientSummary:
			...
			},
			{
				...
				nutritionSummary:
					'180 cal, 17g fat, 3g carbs, 5g protein per 2 tbsp',
			...
			},
			{
				...
				nutritionSummary:
					'190 cal, 15g fat, 14g carbs, 3g protein per serving',
				ingredientSummary:
			...
			// Frozen
			{
				...
				nutritionSummary:
					'290 cal, 11g fat, 38g carbs, 7g protein per serving',
				ingredientSummary:
			...
			},
			{
				...
				brand: 'So Delicious',
				description:
					'Creamy coconut milk-based vanilla frozen dessert.',
				sizeOrVariant: '16 oz',
				...
				nutritionSummary:
					'180 cal, 11g fat, 19g carbs, 1g protein per serving',
				ingredientSummary:
			...
			// Beverages
			{
				...
				nutritionSummary:
					'0 cal, 0g fat, 0g carbs, 0g protein per serving',
			...
			},
			{
				...
				brand: "GT's",
				description:
					'Raw organic kombucha with fresh ginger and probiotics.',
				...
				nutritionSummary:
					'50 cal, 0g fat, 12g carbs, 0g protein per bottle',
				ingredientSummary:
		...
		for (const product of products) {
			const storeIds = getStoresForProduct(
				product.brand,
				product.categories
			);
		...
		console.log(
			`Created ${availabilityEntries.length} availability entries`
		);
