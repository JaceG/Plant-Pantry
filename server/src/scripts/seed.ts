  ...
  try {
    ...
    const products = await Product.insertMany([
      // Dairy Alternatives - Milk
      {
        ...
        brand: 'Oatly',
        description: 'Creamy oat milk designed for frothing and coffee. Made from Swedish oats with a smooth, neutral taste.',
        sizeOrVariant: '32 fl oz',
        categories: ['Dairy Alternatives', 'Oat Milk'],
        tags: ['vegan', 'dairy-free', 'barista', 'organic'],
        isStrictVegan: true,
        imageUrl: 'https://images.unsplash.com/photo-1600718374662-0483d2b9da44?w=400',
      ...
      },
      {
        ...
        brand: 'Califia Farms',
        description: 'Light and refreshing unsweetened almond milk with only 30 calories per serving.',
        ...
        ingredientSummary: 'Almond milk (water, almonds), calcium carbonate, sunflower lecithin',
      },
      {
        ...
        ingredientSummary: 'Organic soymilk (filtered water, organic soybeans), cane sugar, sea salt',
      },
      // Dairy Alternatives - Cheese
      {
        name: 'Classic Chive Cream Cheese',
        brand: 'Miyoko\'s Creamery',
        description: 'Artisan vegan cream cheese made with organic cashews and cultured for authentic tang.',
        sizeOrVariant: '8 oz',
        ...
        ingredientSummary: 'Organic cashews, filtered water, organic coconut cream, chives',
      },
      {
        name: 'Cheddar Style Slices',
        brand: 'Violife',
        description: 'Melty cheddar-style cheese slices perfect for sandwiches and burgers.',
        ...
        ingredientSummary: 'Coconut oil, modified starch, sea salt, olive extract, beta carotene',
      },
      // Protein
      {
        name: 'Organic Extra Firm Tofu',
        brand: 'Nasoya',
        description: 'Organic extra firm tofu, perfect for stir-fries, grilling, or scrambling.',
        sizeOrVariant: '14 oz',
        categories: ['Protein', 'Tofu'],
        tags: ['vegan', 'organic', 'high-protein', 'gluten-free'],
        isStrictVegan: true,
        imageUrl: 'https://images.unsplash.com/photo-1628689469838-524a4a973b8e?w=400',
      ...
      },
      {
        name: 'Organic Tempeh',
        brand: 'Lightlife',
        description: 'Fermented soy tempeh with a nutty flavor and firm texture.',
        sizeOrVariant: '8 oz',
        ...
        ingredientSummary: 'Organic soybeans, water, organic brown rice, culture',
      },
      {
        name: 'Beyond Burger Patties',
        brand: 'Beyond Meat',
        description: 'Plant-based burger patties that look, cook, and satisfy like beef.',
        ...
        ingredientSummary: 'Pea protein, expeller-pressed canola oil, refined coconut oil',
      },
      // Pantry
      {
        name: 'Nutritional Yeast Flakes',
        brand: 'Bragg',
        description: 'Savory, cheesy-tasting nutritional yeast fortified with B vitamins.',
        ...
        ingredientSummary: 'Dried yeast, niacin, pyridoxine hydrochloride, riboflavin, thiamin hydrochloride, folic acid, vitamin B12',
      },
      {
        name: 'Organic Tahini',
        brand: 'Soom',
        description: 'Single-origin Ethiopian sesame tahini with ultra-smooth texture.',
        sizeOrVariant: '12 oz',
      ...
      // Snacks
      {
        ...
        brand: 'Biena',
        description: 'Crunchy roasted chickpeas with a light sea salt seasoning.',
        sizeOrVariant: '5 oz',
        ...
        nutritionSummary: '120 cal, 3.5g fat, 17g carbs, 6g protein per serving',
        ingredientSummary: 'Chickpeas, sunflower oil, sea salt',
      },
      {
        name: 'Organic Dark Chocolate Bar 85%',
        brand: 'Endangered Species',
        description: 'Intense dark chocolate bar with 85% cacao, ethically sourced.',
        sizeOrVariant: '3 oz',
        ...
        ingredientSummary: 'Organic chocolate liquor, organic cane sugar, organic cocoa butter',
      },
      // Frozen
      {
        name: 'Veggie Lover\'s Pizza',
        brand: 'Amy\'s Kitchen',
        description: 'Organic pizza loaded with vegetables and dairy-free cheese.',
        sizeOrVariant: '12 oz',
        ...
        ingredientSummary: 'Organic wheat flour, organic tomato puree, vegan cheese, organic vegetables',
      },
      {
        ...
        ingredientSummary: 'Organic coconut milk, organic cane sugar, vanilla extract',
      },
      // Beverages
      {
        name: 'Cold Brew Coffee Concentrate',
        brand: 'Chameleon',
        description: 'Organic cold brew coffee concentrate, makes up to 6 cups.',
        sizeOrVariant: '32 fl oz',
      ...
      },
      {
        ...
        ingredientSummary: 'Organic raw kombucha, organic ginger juice, organic cane sugar',
      },
    ]);
    ...
    for (const product of products) {
      ...
      for (const storeId of storeIds) {
        const priceRanges = ['$3.99-$4.99', '$4.99-$5.99', '$5.99-$6.99', '$6.99-$7.99', '$7.99-$8.99'];
