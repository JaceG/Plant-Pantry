...
async function searchVeganProducts(
  ...
  const params = new URLSearchParams({
    ...
    fields:
      "code,product_name,brands,categories,categories_tags,labels_tags,ingredients_analysis_tags,ingredients_text,nutriments,image_front_url,image_url,quantity,serving_size",
    page: page.toString(),
