...
export function IndependentStoresCard({
	...
	const filteredStores = useMemo(() => {
		...
		return stores.filter((store) => {
			...
			const regionMatch = store.regionOrScope
				?.toLowerCase()
				.includes(query);
		...
		<div className='independent-stores-card'>
			<div
				...
				<div className='independent-card-actions'>
					<span className='independent-available-badge'>
						✓ Available
					</span>
				...
				<div className='independent-card-expanded'>
					...
					{!hasSearched && (
						<div className='independent-search-prompt'>
							<p>
								Enter a location above to find independent
								stores near you, or browse all stores.
							</p>
						</div>
					)}
				</div>
