...
export function StoreAvailabilitySelector({
  ...
  const [groupedData, setGroupedData] = useState<StoresGroupedResponse | null>(
    null,
  );
  ...
  const [manualLocationIdentifier, setManualLocationIdentifier] = useState("");
  ...
  const filteredExistingStores = useMemo(() => {
    const typeFilter =
      storeMode === "physical"
        ...
        : (s: Store) =>
            s.type === "online_retailer" || s.type === "brand_direct";
    ...
    () =>
      stores
        ...
        .map((s) => {
          ...
          return {
            displayName: location ? `${s.name} — ${location}` : s.name,
            store: s,
          };
        }),
    [stores],
  ...
  const physicalStoreMap = useMemo(
    () =>
      new Map(physicalStoreOptions.map((opt) => [opt.displayName, opt.store])),
    ...
    const loadStores = async () => {
      ...
      try {
        ...
        const missingStoreIds = (value || [])
          ...
          .filter((id) => !storesResponse.items.some((s) => s.id === id));
    ...
    async (placeId: string) => {
      ...
      try {
        ...
        const storeInput = {
          ...
          address:
            placeDetails.place.street || placeDetails.place.formattedAddress,
  ...
  const handleCreateManualPhysicalStore = useCallback(async () => {
    ...
    try {
      const storeInput = {
        ...
        locationIdentifier: manualLocationIdentifier.trim() || undefined,
      };
        ...
        <div className="selection-mode-toggle">
          ...
          >
            ...
            <span className="store-count">
              (
              {storeMode === "physical" ? physicalStoreCount : onlineStoreCount}
              )
            </span>
          </button>
          <button
            ...
            <div className="chain-picker-actions">
              <label className="chain-variants-toggle">
                <input
                  ...
                  onChange={(e) => setApplyToCompanyVariants(e.target.checked)}
                />
                <span>
                  Apply to related variants (e.g., Walmart + Walmart
                  Supercenter)
                </span>
              </label>
              ...
              <div className="store-price-input">
                <div className="price-input-wrapper">
                  ...
                  <input
                    ...
                    value={priceRange}
                    onChange={(e) =>
                      handlePriceInputChange(e.target.value, setPriceRange)
                    }
                  />
                </div>
              </div>
              ...
              <div className="chain-picker-buttons">
                ...
                <span className="chain-picker-hint">
                  Adds this product to all locations in the chain (and variants
                  if enabled).
                </span>
              </div>
            </div>
            ...
            <div className="existing-store-search-wrapper">
              ...
              {showExistingDropdown && (
                <div className="existing-stores-dropdown">
                  {loadingStores ? (
                    <div className="dropdown-message">Loading stores...</div>
                  ) : storeMode === "physical" ? (
                    // Physical stores - show chains first, then independent stores
                    <>
                      {/* Store Chains */}
                      {groupedData && groupedData.chains.length > 0 && (
                        <>
                          <div className="dropdown-header">🏬 Store Chains</div>
                            ...
                            {groupedData.chains
                              .filter((group) => {
                                ...
                                return group.chain.name
                                  .toLowerCase()
                                  .includes(existingStoreSearch.toLowerCase());
                              })
                              .map(({ chain, locationCount }) => (
                                <div
                                  key={chain.id}
                              ...
                              {groupedData.independentStores
                                ...
                                .map((store) => (
                                  <div
                                    ...
                                    onClick={() =>
                                      handleExistingStoreSelect(store)
                                    }
                                  >
                                    <div className="store-option-name">
                                      {store.name}
                  ...
                  filteredExistingStores.length === 0 ? (
                    ...
                    <>
                      <div className="dropdown-header">🌐 Online Stores</div>
                      <div className="dropdown-list">
                        {filteredExistingStores.map((store) => (
                          <div
                            key={store.id}
                            className="existing-store-option"
                            onClick={() => handleExistingStoreSelect(store)}
                          >
                            <div className="store-option-name">
                              {store.name}
                            </div>
          ...
          <div className="new-store-section">
            ...
            <div className="selection-mode-toggle">
              <button
                type="button"
                className={`selection-mode-button ${
                  physicalNewMode === "google_places" ? "active" : ""
                }`}
                onClick={() => setPhysicalNewMode("google_places")}
              >
                📍 Google Places
              </button>
              <button
            ...
            <div className="new-store-chain-section">
              <label>Add to a chain (instead of a single location)</label>
              <AutocompleteInput
              ...
              <div className="new-store-chain-hint">
                Select a chain to add “all locations” (or choose a specific
                location next).
              </div>
            </div>
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          setChains((prev) => {
                            if (prev.some((c) => c.id === res.chain.id))
                              return prev;
                            return [...prev, res.chain];
                          });
                          setSelectedChain(res.chain);
              ...
              <div className="online-store-form">
                ...
                <div className="form-group">
                  ...
                  <AutocompleteInput
                    ...
                    onSelect={(name) => {
                      const maybe = chainNameToChain.get(name);
                      if (maybe) {
                ...
                {manualChainId && (
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setManualLocationIdentifier(e.target.value)
                      }
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setManualStoreAddress(e.target.value)}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setManualStoreCity(e.target.value)}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setManualStoreState(e.target.value)}
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setManualStoreZip(e.target.value)}
          ...
          <div className="online-store-form">
            ...
            <div className="form-group">
              ...
              <select
                ...
                onChange={(e) =>
                  setOnlineStoreType(
                    e.target.value as "online_retailer" | "brand_direct",
                  )
                }
                className="form-input"
              >
                <option value="online_retailer">
                  Online Retailer (e.g., Amazon, Thrive Market)
                </option>
        ...
        {duplicateWarning?.show && (
          <div className="duplicate-warning">
            ...
            <p className="duplicate-warning-text">
              We found similar stores that may be what you're looking for. Would
              you like to use an existing store or create a new one?
            </p>
            <div className="similar-stores-list">
              {duplicateWarning.similarStores.map((store) => (
                <div
                  ...
                  onClick={() => handleSelectExistingStore(store)}
                >
                  <div className="similar-store-info">
                    ...
                    {store.type === "brick_and_mortar" ? (
                      ...
                      <span className="similar-store-location">
                        {store.websiteUrl || store.regionOrScope}
                      </span>
                    )}
                  </div>
                  <span className="use-this-btn">Use this →</span>
                </div>
              ))}
            </div>
                      ...
                      onChange={(e) => {
                        ...
                        const validValue =
                          parts.length > 2
                            ...
                            : cleaned;
                        handleUpdatePriceRange(avail.storeId, validValue);
                      }}
                    />
                  </div>
                </div>
      ...
      {chainValue.length > 0 && (
        <div className="selected-stores-list">
          ...
          {chainValue.map((c) => {
            ...
            return (
              <div key={c.chainId} className="selected-store-item">
                <div className="store-item-info">
        ...
        >
          ...
          >
            ...
            <div className="modal-body">
              {chainModalError && (
                <div className="chain-modal-error">⚠️ {chainModalError}</div>
              )}
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChainFormChange("name", e.target.value)
                  }
              ...
              <div className="form-group">
                <label htmlFor="chain-slug">URL Slug (optional)</label>
                <input
                  type="text"
                  id="chain-slug"
                  value={chainForm.slug}
                  onChange={(e) =>
                    handleChainFormChange("slug", e.target.value)
                  }
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleChainFormChange("type", e.target.value)
                  }
                >
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChainFormChange("websiteUrl", e.target.value)
                  }
                  placeholder="https://..."
                />
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChainFormChange("logoUrl", e.target.value)
                  }
                  placeholder="https://..."
                />
              </div>
