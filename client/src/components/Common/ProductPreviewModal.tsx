      ...
      <div className="preview-modal-container" onClick={handleModalClick}>
        ...
        <div className="preview-modal-content">
          ...
          <div className="preview-modal-info">
            <span className="preview-brand">{displayProduct.brand}</span>
              ...
              <>
                  ...
                  displayProduct.reviewCount > 0 && (
                    <div className="preview-rating">
                        ...
                        {Array(5)
                          ...
                          .map((_, i) => (
                            <span
                              key={i}
                              className={
                                i < Math.round(displayProduct.averageRating!)
                                  ? "star star-full"
                                  : "star star-empty"
                              }
                            >
                      ...
                      <span className="preview-rating-text">
                        {displayProduct.averageRating.toFixed(1)} (
                        {displayProduct.reviewCount}{" "}
                        {displayProduct.reviewCount === 1
                          ? "review"
                          : "reviews"}
                        )
                      </span>
                ...
                {displayProduct.tags && displayProduct.tags.length > 0 && (
                  <div className="preview-tags">
                    {displayProduct.tags.slice(0, 5).map((tag) => (
        ...
        <p className="preview-hint">Click anywhere to view full product page</p>
      </div>
    </>
  );
}
