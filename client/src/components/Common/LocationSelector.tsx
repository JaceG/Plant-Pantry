...
export function LocationSelector() {
  ...
  return (
    <div className="location-selector" ref={dropdownRef}>
      <button
        className={`location-trigger ${hasLocation ? "has-location" : ""}`}
      ...
      >
        ...
        <span className={`location-chevron ${isOpen ? "open" : ""}`}>▼</span>
      </button>
      ...
      {isOpen && (
        <div className="location-dropdown">
          <div className="dropdown-header">
            <h4>Your Location</h4>
            {hasLocation && (
              <button className="clear-location-btn" onClick={handleClear}>
                Clear
              </button>
            )}
          </div>
          ...
          <div className="city-list">
            <div className="city-list-header">Or choose a city:</div>
            {cities.length === 0 ? (
              ...
              cities.map((city) => (
                <button
                  ...
                  onClick={() => handleCitySelect(city.cityName, city.state)}
                >
