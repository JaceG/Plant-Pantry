...
export const adminApi = {
  ...
  updateUserRole(
    ...
    return httpClient.put<{ message: string }>(`/admin/users/${userId}/role`, {
      role,
    });
  },
  ...
  deleteChain(chainId: string): Promise<{ message: string }> {
    return httpClient.delete<{ message: string }>(`/admin/chains/${chainId}`);
  },
  ...
  unarchiveFilter(
    ...
    return httpClient.post<{ message: string }>("/admin/filters/unarchive", {
      type,
      value,
    });
  },
  ...
  setFilterDisplayName(
    ...
    return httpClient.put<{ message: string }>("/admin/filters/display-name", {
      type,
      value,
      displayName,
    });
  ...
  reorderFeaturedProducts(productIds: string[]): Promise<{ message: string }> {
    return httpClient.put<{ message: string }>(
  ...
  getCityPages(): Promise<{ cityPages: AdminCityPage[] }> {
    return httpClient.get<{ cityPages: AdminCityPage[] }>("/admin/city-pages");
  },
  ...
  deleteCityPage(slug: string): Promise<{ message: string }> {
    return httpClient.delete<{ message: string }>(`/admin/city-pages/${slug}`);
  },
