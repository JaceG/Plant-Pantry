				...
				<div className='profile-sections'>
					...
					<section className='profile-section'>
						...
						<p className='section-description'>
							Connect multiple sign-in methods to your account for
							easier access and backup options.
						</p>
				...
				<div
					...
					<div
						...
						<p className='modal-description'>
							...
							as an additional sign-in method.
						</p>
						...
						<div className='password-requirements'>
							<span
								className={
									newPassword.length >= 8 ? 'met' : ''
								}>
								At least 8 characters
							</span>
							<span
								className={
									/[a-zA-Z]/.test(newPassword) ? 'met' : ''
								}>
								Contains a letter
							</span>
							<span
								className={
									/[0-9]/.test(newPassword) ? 'met' : ''
								}>
								Contains a number
							</span>
						</div>
