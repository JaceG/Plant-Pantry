        ...
        <form onSubmit={handleSubmit} className="auth-form" noValidate>
          <div className="form-group">
            ...
            <span className="field-hint">
              Your real name is kept private and never displayed publicly
            </span>
          </div>

          <div
            className={`form-group ${
              fieldErrors.displayName && touched.displayName ? "has-error" : ""
            }`}
          >
          ...
          >
            ...
            <input
              ...
              autoComplete="email"
              className={
                fieldErrors.email && touched.email ? "input-error" : ""
              }
            />
          ...
          >
            ...
            <div className="password-requirements">
              <span
                className={password.length >= PASSWORD_MIN_LENGTH ? "met" : ""}
              >
