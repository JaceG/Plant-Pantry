...
export function CityLandingScreen() {
  ...
  const [groupedStores, setGroupedStores] = useState<CityStoresGrouped | null>(
    null,
  );
  ...
  const [editingField, setEditingField] = useState<CityContentEditField | null>(
    null,
  );
    ...
    return (
      <div className="city-landing-screen">
        ...
        <SEO
          ...
          description="This city page could not be found. It may not exist or isn't available yet."
          noindex={true}
        />
        <div className="city-error">
          <h2>City Not Found</h2>
          <p>
            The city page you're looking for doesn't exist or isn't available
            yet.
          </p>
  ...
  // Build SEO description for city page
  const seoDescription = cityData.description
    ? cityData.description.slice(0, 155)
    : `Find vegan groceries in ${cityData.cityName}, ${cityData.state}. Discover ${stores.length} store locations with ${totalProducts} plant-based products.`;

  // Build structured data for local business/place
  const cityStructuredData = {
    "@context": "https://schema.org/",
    "@type": "Place",
    name: `${cityData.cityName}, ${cityData.state}`,
  ...
  return (
    <div className="city-landing-screen">
      <SEO
        title={`Vegan Groceries in ${cityData.cityName}, ${cityData.state}`}
        description={seoDescription}
            ...
            <div className="edit-field-container">
              ...
              <div className="edit-actions">
                ...
                <button
                  ...
                  disabled={submittingEdit || editValue === cityData.cityName}
                >
            ...
            <div className="edit-field-container">
              ...
              <div className="edit-actions">
                ...
                <button
                  className="edit-submit"
                  onClick={handleSubmitEdit}
                  disabled={submittingEdit || editValue === cityData.headline}
                >
                  {submittingEdit ? "Submitting..." : "Submit"}
                </button>
              </div>
            ...
            <div className="edit-field-container edit-description-container">
              ...
              <div className="edit-actions">
                ...
                <button
                  ...
                  onClick={handleSubmitEdit}
                  disabled={
                    submittingEdit || editValue === cityData.description
                  }
                >
                  {submittingEdit ? "Submitting..." : "Submit"}
                </button>
          ...
          >
            ...
            <div className="slide-panel stores-view">
              ...
              (groupedStores.chainGroups.length > 0 ||
                ...
                <div className="stores-list grouped">
                  ...
                  {groupedStores.chainGroups.map((group) => (
                    <div key={group.chain.id} className="chain-group">
                      <div
                        className="chain-header"
                        onClick={() => toggleChainExpanded(group.chain.id)}
                      >
                        <span className="chain-expand-icon">
                          {expandedChains.has(group.chain.id) ? "?" : "?"}
                        </span>
                        <div className="chain-info">
                          <h3 className="chain-name">{group.chain.name}</h3>
                          <span className="chain-meta">
                            {group.stores.length} location
                            {group.stores.length !== 1 ? "s" : ""} �{" "}
                            {group.totalProductCount} product
                            {group.totalProductCount !== 1 ? "s" : ""}
                          </span>
                        </div>
                        <Link
                          ...
                          {group.stores.map((store) => (
                            ...
                            >
                              <div className="store-info">
                                ...
                                {store.address && store.locationIdentifier && (
                  ...
                  {groupedStores.independentStores.length > 0 && (
                    <>
                      ...
                      {groupedStores.independentStores.map((store) => (
                        <div
                          key={store.id}
                ...
                <div className="empty-state">
                  ...
                  <p className="empty-hint">
                    Know a store with vegan products? Help us grow our database!
                  </p>
                </div>
              )}
              ...
              <div className="contribution-section">
                <button
                  ...
                  onClick={() => setShowSuggestStoreModal(true)}
                >
            ...
            <div className="slide-panel store-detail-view">
              {selectedStore && (
                <>
                  <div className="panel-header">
                    <button onClick={handleBackToStores} className="back-btn">
                      ? Back to stores
                    </button>
                  ...
                  <div className="products-section">
                    ...
                    {loadingProducts ? (
                      ...
                      <div className="empty-products">
                        <p>No products listed at this store yet.</p>
                        <p className="empty-hint">
                          Found something here?{" "}
                          <Link to="/search">Search for it</Link> and report
                          availability!
                        </p>
                      </div>
                    )}
