...
export function HomeScreen() {
  ...
  const citySlug = userLocation
    ? cities.find(
        (c) =>
          c.cityName === userLocation.city && c.state === userLocation.state,
      )?.slug
    : undefined;
  ...
  // Build SEO metadata based on search/filter context
  ...
  const seoDescription = searchQuery
    ? `Find "${searchQuery}" and other vegan products. Browse plant-based groceries and discover where to buy them.`
    : "Search our database of vegan products. Find plant-based groceries and discover where to buy them near you.";
          ...
          <div className="products-section">
            ...
            {hasLocation && (
              <div className="location-filter-banner">
                ...
                <button className="clear-location-btn" onClick={clearLocation}>
                  Show all locations
                </button>
                {citySlug && (
                  <Link
