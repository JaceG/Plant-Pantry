...
export function AdminStoreAvailability() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      setSearchResults(response.items.filter((p) => !existingIds.has(p.id)));
    } catch (err) {
            ...
            {!selectedStore ? (
              <div className="no-store-selected">
                <div className="empty-state">
                  ...
                  <p>
                    Choose a store from the list to manage its product
                    availability
                  </p>
                </div>
              </div>
              ...
              <>
                ...
                <section className="current-products-section">
                  <h3>Products at this Store ({storeProducts.length})</h3>
