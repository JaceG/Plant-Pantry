      ...
      <div className="admin-filters">
        ...
        {showAddForm && (
          <div className="add-filter-form">
            <h3>Add New {activeTab === "category" ? "Category" : "Tag"}</h3>
            <div className="form-fields">
              <div className="form-field">
                ...
                <input
                  ...
                  placeholder={`e.g., ${
                    activeTab === "category" ? "chocolate bars" : "organic"
                  }`}
                  className="filter-input"
                  autoFocus
                />
                <span className="form-hint">
                  This is the internal value stored in the database
                </span>
              </div>
              <div className="form-field">
                ...
                />
                <span className="form-hint">
                  How the filter appears to users (defaults to value if empty)
                </span>
              </div>
            </div>
                    ...
                    <>
                      ...
                      {filter.archived && filter.archivedAt && (
                        <span className="filter-meta">
                          Archived{" "}
                          {new Date(filter.archivedAt).toLocaleDateString()}
                        </span>
                      )}
                    </>
                  )}
