          ...
          <div className="brands-list">
            {filteredOfficialBrands.length === 0 ? (
              ...
              filteredOfficialBrands.map((brand) => (
                <div key={getBrandKey(brand)} className="brand-row official">
                      ...
                      {brand.childCount > 0 && (
                        <>
                          <span className="product-count total-count">
                            {brand.totalProductCount} total
                          </span>
                          <span className="child-count">
                            +{brand.childCount} sub-brand
                            {brand.childCount !== 1 ? "s" : ""}
                          </span>
                        </>
                      )}
                    </div>
                  ...
                  <div className="brand-actions">
                    <Button
                      ...
                      onClick={() => handleToggleOfficial(brand)}
                    >
                      Remove Official
                    </Button>
                  </div>
          ...
          >
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <p className="modal-description">
                Create a brand that doesn't currently exist in the product
                database. This is useful for parent brands like "Amazon" to
                group sub-brands.
              </p>
              ...
              <div className="modal-actions">
                ...
                <Button
                  ...
                  disabled={createBrandLoading || !newBrandName.trim()}
                >
                  {createBrandLoading ? "Creating..." : "Create Official Brand"}
                </Button>
              </div>
            </div>
          </div>
        ...
        <li key={child.id || child.brandName} className="child-item">
          ...
          {child.id && (
            <button
              ...
              onClick={() => handleUnassign(child.id!, child.displayName)}
            >
              Unassign
            </button>
          )}
